...
/**
 * Demonstrative example of thread unsafe nature of {@link SimpleDateFormat}.
 * Adapted from example at
 * https://www.callicoder.com/java-simpledateformat-thread-safety-issues/.
 */
public class SimpleDateFormatThreadUnsafeDemonstration
{
    /** Date/Time Format. */
    ...
    private static void parseDate(final String dateTimeStringToParse)
    {
        try
        {
            final Date date = SIMPLE_DATE_FORMAT.parse(dateTimeStringToParse);
